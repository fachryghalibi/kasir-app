...
<div class="container-fluid px-6 py-8">
    ...
    <div class="mb-6">
        ...
        <p class="text-gray-600 ml-9">Update informasi vendor {{ $vendor->name }}</p>
    </div>

    <!-- Form Card -->
    <div class="max-w-4xl">
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            <form action="{{ route('boss.vendors.update', $vendor) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="notes" 
                                  ...
                                  placeholder="Catatan tambahan tentang vendor ini">{{ old('notes', $vendor->notes) }}</textarea>
                        @error('notes')
                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
